                        ...
                        @if ($data->count())
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-white whitespace-no-wrap"></td>
    ...
    <x-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            <div class="mt-4">
                ...
                <x-input id="name" type="text" class="block w-full mt-1" wire:model.debounce.800ms="name"
                    autofocus />
                <x-input-error for="name" class="mt-2" />
            </div>
            <div class="mt-4">
                <x-label for="email" value="{{ __('E-mail') }}" />
                <x-input id="email" type="text" class="block w-full mt-1" wire:model.debounce.800ms="email"
                    autofocus />
