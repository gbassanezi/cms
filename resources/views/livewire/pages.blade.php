<div class="p-6">
    ...
    <x-dialog-modal wire:model="modalFormVisible">
        ...
        <x-slot name="content">
            ...
            <x-input id="title" type="text" class="mt-1 block w-full" wire:model.defer="createApiTokenForm.title"
                autofocus />
            <x-input-error for="title" class="mt-2" /><br>
                ...
                <div class="btx">
                    ...
                    <div class="relative mb-4 flex flex-wrap items-stretch w-full">
                        ...
                        <input type="text" name="slug" id="slug" autocomplete="slug" class="rounded dark:bg-gray-800" placeholder="slug here" />
